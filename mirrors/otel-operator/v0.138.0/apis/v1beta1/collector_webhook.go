...
import (
	...
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/config"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/fips"
	ta "github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/manifests/targetallocator/adapters"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/naming"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/rbac"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/pkg/featuregate"
)
