...
// TODO: Refactor this logic, centralize it. See: https://github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/issues/2603
...
func extractElements(elements map[string]interface{}) []string {
	...
	//		see https://github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/issues/2603
	if elements == nil {
		return []string{}
	}
