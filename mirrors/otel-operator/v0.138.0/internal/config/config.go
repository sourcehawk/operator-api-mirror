...
import (
	...
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/certmanager"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/collector"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/opampbridge"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/openshift"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/prometheus"
	autoRBAC "github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/rbac"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/autodetect/targetallocator"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/internal/version"
	"github.com/sourcehawk/operator-api-mirrors/mirrors/otel-operator/v0.138.0/pkg/constants"
)
