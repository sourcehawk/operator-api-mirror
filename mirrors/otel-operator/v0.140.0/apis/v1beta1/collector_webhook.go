...
import (
	...
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/config"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/fips"
	ta "github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/manifests/targetallocator/adapters"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/naming"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/rbac"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/pkg/featuregate"
)
