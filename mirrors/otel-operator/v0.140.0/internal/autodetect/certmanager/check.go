...
import (
	...
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/autodetectutils"
	rbac "github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/rbac"
)
