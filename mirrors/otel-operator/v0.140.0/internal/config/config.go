...
import (
	...
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/certmanager"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/collector"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/opampbridge"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/openshift"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/prometheus"
	autoRBAC "github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/rbac"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/autodetect/targetallocator"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/internal/version"
	"github.com/sourcehawk/operator-api-mirror/otel-operator/v0.140.0/pkg/constants"
)
