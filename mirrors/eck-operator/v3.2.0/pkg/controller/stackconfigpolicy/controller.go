...
import (
	...
	commonv1 "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/apis/common/v1"
	esv1 "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/apis/elasticsearch/v1"
	kibanav1 "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/apis/kibana/v1"
	policyv1alpha1 "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/apis/stackconfigpolicy/v1alpha1"
	"github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/common"
	commonesclient "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/common/esclient"
	"github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/common/events"
	commonlabels "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/common/labels"
	"github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/common/license"
	...
	esclient "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/elasticsearch/client"
	"github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/elasticsearch/filesettings"
	eslabel "github.com/sourcehawk/operator-api-mirror/eck-operator/v3.2.0/pkg/controller/elasticsearch/label"
